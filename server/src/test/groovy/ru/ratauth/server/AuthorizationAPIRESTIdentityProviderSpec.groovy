...
identifier received by REST-based identity provider''')
    ...
    private static void mockRestProviderWithResponse(mockResponse) {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalTo("data.username=login&data.enroll=username&data.password=password&data.acr_values=username&relyingparty=DummyIdentityProvider&enroll=username"))
                .willReturn(
                aResponse()
    ...
    private static void mockRestProviderWithErrorResponse() {
        stubFor(post(
                ...
                .withHeader(HttpHeader.CONTENT_TYPE.asString(), equalTo(MediaType.APPLICATION_JSON_VALUE))
                .withBasicAuth("llogin", "ppassword")
                .withRequestBody(equalTo("data.username=unprocessable_login&data.enroll=username&data.password=password&data.acr_values=username&relyingparty=DummyIdentityProvider&enroll=username"))
                .willReturn(
                aResponse()
    ...
    private static void mockRestProviderWithInvalidLoginResponse() {
        stubFor(post(
                ...
                .withHeader(HttpHeader.CONTENT_TYPE.asString(), equalTo(MediaType.APPLICATION_JSON_VALUE))
                .withBasicAuth("llogin", "ppassword")
                .withRequestBody(equalTo("data.username=invalid_login&data.enroll=username&data.password=password&data.acr_values=username&relyingparty=DummyIdentityProvider&enroll=username"))
                .willReturn(
                aResponse()
