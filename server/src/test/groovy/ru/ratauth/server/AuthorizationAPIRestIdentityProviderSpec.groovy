...
identifier received by REST-based identity provider''')
    ...
    private static void mockRestProviderWithResponse(mockResponse) {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalTo("{\"userInfo\":{},\"relying_party\":\"DummyIdentityProvider\",\"enroll\":\"username\",\"data\":{\"password\":\"password\",\"enroll\":\"username\",\"username\":\"login\",\"acr_values\":\"username\"}}"))
                .willReturn(
                aResponse()
    ...
    private static void mockRestProviderWithErrorResponse() {
        stubFor(post(
                ...
                .withHeader(HttpHeader.CONTENT_TYPE.asString(), equalTo(MediaType.APPLICATION_JSON_VALUE))
                .withBasicAuth("llogin", "ppassword")
                .withRequestBody(equalTo("{\"userInfo\":{},\"relying_party\":\"DummyIdentityProvider\",\"enroll\":\"username\",\"data\":{\"password\":\"password\",\"enroll\":\"username\",\"username\":\"unprocessable_login\",\"acr_values\":\"username\"}}"))
                .willReturn(
                aResponse()
    ...
    private static void mockRestProviderWithInvalidLoginResponse(mockResponse) {
        stubFor(post(
                ...
                .withHeader(HttpHeader.CONTENT_TYPE.asString(), equalTo(MediaType.APPLICATION_JSON_VALUE))
                .withBasicAuth("llogin", "ppassword")
                .withRequestBody(equalTo("{\"userInfo\":{},\"relying_party\":\"DummyIdentityProvider\",\"enroll\":\"username\",\"data\":{\"password\":\"password\",\"enroll\":\"username\",\"username\":\"invalid_login\",\"acr_values\":\"username\"}}"))
                .willReturn(
                aResponse()
